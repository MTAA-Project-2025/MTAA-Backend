...
namespace MTAA_Backend.Domain.Interfaces
{
    ...
    {
        public Task<IReadOnlyList<ScoredPoint>> GetPostVectors(string collectionName, float[] userVector, ulong limit, string userId, CancellationToken cancellationToken = default);
