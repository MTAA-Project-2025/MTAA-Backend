...
{
    public class ForbidUserGroupMembershipNotificationsHandler(ILogger<ForbidUserGroupMembershipNotificationsHandler> logger,
        IStringLocalizer<ErrorMessages> localizer,
        MTAA_BackendDbContext dbContext) : IRequestHandler<ForbidUserGroupMembershipNotifications>
    {
